...
$.ajax({
    ...
    data: 'acao=listarGraficoQtdAgendamento',
    dataType: "json",
    beforeSend: function(){},
    error: function(error){},
    success: retornoListarGraficoQtdAgendamento
});
...
function retornoListarGraficoQtdAgendamento(resp, error)
{
	var lineChartData = {
	...
	var chart1 = document.getElementById("line-chart").getContext("2d");
	var myLine = new Chart(chart1).Line(lineChartData, {responsive: true});
}