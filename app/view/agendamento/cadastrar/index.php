						...
						<form id="formCadastrarAgendamento" action="../action/inserir.php" method="POST">
							...
							<div class="col-md-6">					
								<div class="form-group">
									...
									<select class="form-control" id="listarPaciente" name="agendamento[paciente_usuario]">
...
<?php require_once('footer.php'); ?>
	<script type="text/javascript" src="../../assets/js/pags/agendamento/cadastrar/index.js"></script>
</body>
</html>