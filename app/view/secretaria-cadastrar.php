	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Cadastrar Secretária</li>
			</ol>
		</div><!--/.row-->			
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Cadastrar Secretária</div>
					<div class="panel-body">
						<div id="resposta"></div>
						<form id="formCadastrarSecretaria" action="../action/inserir.php" method="POST">
							<input type="hidden" name="acao" value="cadastrarSecretaria">
							<div class="col-md-6">
...
<?php require_once('footer.php'); ?>
	<script type="text/javascript" src="../../assets/js/pags/secretaria-cadastrar.js"></script>
</body>
</html>