  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">     
    ...
    <div class="row" align="center">
      <div class="col-md-12">
        <h3>
              SysMedic
              <small id="nomePagina">Calendário</small>
          </h3>
      </div>
    </div><!--/.row-->
    ...
    <section class="content">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div id="external-events">
                <center>
                  <button id="botaoVisualizarAgendamentoMedico" type="submit" class="btn btn-success">Visualizar</button>
      ...
      <div class="row hidden" id="divAgendamentoDoDia">
        <div class="col-lg-12">
...
<?php require_once('footer.php'); ?>
  ...
  <script type="text/javascript" src="../../assets/js/pags/inicio/medico.js"></script>
